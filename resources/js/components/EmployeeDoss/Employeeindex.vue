...
<div class="flex flex-col">
    <div class="flex " id="divCreer">
        ...
        <button class="custom-btn btn-1Employee" id="rlink1" @click="$router.push('/employees/create')"><i id="iAddEmpl" class="bx bx-user-check icon_table"></i>Créer un employé</button>
